...
#define ADC0SSMUX(SEQ)         *((volatile u32*)(ADC0_BASE+ADC_SSMUXn[SEQ]))
#define ADC1SSMUX(SEQ)         *((volatile u32*)(ADC1_BASE+ADC_SSMUXn[SEQ]))
...
#define ADC0SSCTL(SEQ)        *((volatile u32*)(ADC0_BASE+ADC_SSCTLn[SEQ]))
...
#define ADC0_SSFIFO(SEQ)    *((volatile u32*)(ADC0_BASE+ADC_FIFOn[SEQ]))
