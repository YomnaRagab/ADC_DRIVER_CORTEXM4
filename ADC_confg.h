...
strGroupInfo adc_groups[NUMOFGROUPS]={0,CONV_ONE_SHOT,SINGLE_ACCESS,SW,NONE,{AIN0,'\0'}};
strModuleInfo adc_confg[NUMOFMODULES]={0,SS3,SS_125k,1,0};
//#define SAMPLE_SPEED SS_125k // 125k , 250k , 500k , 1M
