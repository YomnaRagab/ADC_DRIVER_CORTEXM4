...
void GPIO_Init(void)
{
	...
	{
		//CONFIGURE THE PINS WHOSE INTERRUPTS ARE ENABELED AS INPUTS
		//GPIODIR(PORTA)=CONCBIT(PORTA_PIN7_INT,PORTA_PIN6_INT,PORTA_PIN5_INT,PORTA_PIN4_INT,PORTA_PIN3_INT,PORTA_PIN2_INT,PORTA_PIN1_INT,PORTA_PIN0_INT);
		//ENABELE PORTA'S INTERRUPT
		SET_BIT(EN0,PORTA_INT_NUM);
		//THEN TO AVOID FALSE INTERRUPTS WE FOLLOW THE STEPS IN THE DATASHEET
		GPIOIM(PORTA)=0x00;
	...
	if(PORTB_PIN0_INT|PORTB_PIN1_INT|PORTB_PIN2_INT|PORTB_PIN3_INT|PORTB_PIN4_INT|PORTB_PIN5_INT|PORTB_PIN6_INT|PORTB_PIN7_INT)
		{
			//CONFIGURE THE PINS WHOSE INTERRUPTS ARE ENABELED AS INPUTS
			//GPIODIR(PORTB)=CONCBIT(PORTB_PIN7_INT,PORTB_PIN6_INT,PORTB_PIN5_INT,PORTB_PIN4_INT,PORTB_PIN3_INT,PORTB_PIN2_INT,PORTB_PIN1_INT,PORTB_PIN0_INT);
			//ENABELE PORTA'S INTERRUPT
	...
	if(PORTC_PIN0_INT|PORTC_PIN1_INT|PORTC_PIN2_INT|PORTC_PIN3_INT|PORTC_PIN4_INT|PORTC_PIN5_INT|PORTC_PIN6_INT|PORTC_PIN7_INT)
		{
			//CONFIGURE THE PINS WHOSE INTERRUPTS ARE ENABELED AS INPUTS
			//GPIODIR(PORTC)=CONCBIT(PORTC_PIN7_INT,PORTC_PIN6_INT,PORTC_PIN5_INT,PORTC_PIN4_INT,PORTC_PIN3_INT,PORTC_PIN2_INT,PORTC_PIN1_INT,PORTC_PIN0_INT);
			//ENABELE PORTA'S INTERRUPT
	...
	if(PORTD_PIN0_INT|PORTD_PIN1_INT|PORTD_PIN2_INT|PORTD_PIN3_INT|PORTD_PIN4_INT|PORTD_PIN5_INT|PORTD_PIN6_INT|PORTD_PIN7_INT)
			{
				//CONFIGURE THE PINS WHOSE INTERRUPTS ARE ENABELED AS INPUTS
				//GPIODIR(PORTD)=CONCBIT(PORTD_PIN7_INT,PORTD_PIN6_INT,PORTD_PIN5_INT,PORTD_PIN4_INT,PORTD_PIN3_INT,PORTD_PIN2_INT,PORTD_PIN1_INT,PORTD_PIN0_INT);
				//ENABELE PORTA'S INTERRUPT
	...
	if(PORTE_PIN0_INT|PORTE_PIN1_INT|PORTE_PIN2_INT|PORTE_PIN3_INT|PORTE_PIN4_INT|PORTE_PIN5_INT)
			{
				//CONFIGURE THE PINS WHOSE INTERRUPTS ARE ENABELED AS INPUTS
				//GPIODIR(PORTE)=CONCBIT(0,0,PORTE_PIN5_INT,PORTE_PIN4_INT,PORTE_PIN3_INT,PORTE_PIN2_INT,PORTE_PIN1_INT,PORTE_PIN0_INT);
				//ENABELE PORTA'S INTERRUPT
	...
	if(PORTF_PIN0_INT|PORTF_PIN1_INT|PORTF_PIN2_INT|PORTF_PIN3_INT|PORTF_PIN4_INT)
			{
				//CONFIGURE THE PINS WHOSE INTERRUPTS ARE ENABELED AS INPUTS
				//GPIODIR(PORTF)=CONCBIT(0,0,0,PORTF_PIN4_INT,PORTF_PIN3_INT,PORTF_PIN2_INT,PORTF_PIN1_INT,PORTF_PIN0_INT);
				//ENABELE PORTA'S INTERRUPT
